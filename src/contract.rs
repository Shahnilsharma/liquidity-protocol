...
mod tests {
    ...
    fn test_admin_deposit_yield_success() {
        ...
        let user_info = mock_info("user", &coins(1000, "uzig"));
    ...
    fn test_admin_deposit_yield_unauthorized() {
        ...
        let non_admin_info = mock_info("attacker", &coins(100, "uzig"));
        let err = execute(
            deps.as_mut(),
            env,
            non_admin_info,
    ...
    fn test_admin_deposit_yield_wrong_denom() {
        ...
        let admin_info = mock_info("creator", &coins(100, "wrongtoken"));
        let err = execute(
            deps.as_mut(),
            env,
            admin_info,
    ...
    fn test_admin_deposit_yield_zero_amount() {
        ...
        let admin_info = mock_info("creator", &coins(0, "uzig"));
        let err = execute(
            deps.as_mut(),
            env,
            admin_info,
    ...
    fn test_admin_deposit_yield_multiple_deposits() {
        ...
        let admin_info = mock_info("creator", &coins(50, "uzig"));
        execute(
            deps.as_mut(),
            env.clone(),
            admin_info.clone(),
        ...
        let admin_info2 = mock_info("creator", &coins(100, "uzig"));
        execute(
            deps.as_mut(),
            env.clone(),
            admin_info2,
